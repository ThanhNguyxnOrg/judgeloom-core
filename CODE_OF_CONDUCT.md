...
This Code of Conduct applies within all community spaces — including the GitHub repository, issue tracker, pull requests, and discussions — and also applies when an individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported privately to the project maintainer through [GitHub Security Advisories](https://github.com/ThanhNguyxnOrg/judgeloom-core/security/advisories/new) or by opening a private contact via the maintainer's GitHub profile [@ThanhNguyxn07](https://github.com/ThanhNguyxn07).
